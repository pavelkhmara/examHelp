...
Generated: Tue, Oct 21, 2025  9:11:44 AM
...
```php
// Summary: class/table/fillable/casts/hidden/guarded + relations
9:class ExamExampleQuestion extends Model
13:    protected $table = 'exam_example_questions';
15:    protected $fillable = [
21:    protected $casts = [
// Relations (best-effort grep)
28:        return $this->belongsTo(Exam::class, 'exam_id', 'id');
33:        return $this->belongsTo(ExamCategory::class, 'exam_category_id');
...
16:    protected $fillable = ['exam_id','prompt','answer','type','payload'];
18:    protected $casts = [
// Relations (best-effort grep)
...
class Question extends Model
{
    ...
    protected $fillable = ['exam_id','prompt','answer','type','payload'];
...
_No tables found or DB connection unavailable._

    ...
    public function fields(NovaRequest $request)
    {
        $fields = [
            ...
            Text::make('Full Exam View', function () {
                ...
                return '<a href="' . $url . '" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition duration-150 ease-in-out" style="text-decoration: none;">
